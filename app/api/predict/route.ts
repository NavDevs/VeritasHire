...
function getMockPrediction(jobDescription: string) {
  ...
  if (text.includes("urgent") || text.includes("urgently") || text.includes("immediately") || text.includes("asap") || text.includes("hurry")) {
    riskFactors.push("Urgent hiring pressure");
    riskScore += 20;
  }
  
  if (text.includes("click here") || text.includes("apply now") || text.includes("apply immediately")) {
  ...
  if (text.includes("no interview") || text.includes("instant hire") || text.includes("direct selection")) {
    riskFactors.push("No interview process");
    riskScore += 30;
    isFake = true;
  }

  if (text.includes("registration fee") || text.includes("training fee") || text.includes("pay") || text.includes("deposit")) {
  ...
  if (text.includes("personal details") || text.includes("personal information") || text.includes("share your")) {
  ...
  if (text.includes("joining bonus") || text.includes("sign on bonus") || text.includes("instant bonus")) {
    riskFactors.push("Instant joining bonus");
    riskScore += 20;
  }

  if (text.includes("training provided") || text.includes("complete training") || text.includes("free training")) {
  ...
  if (text.includes("limited") || text.includes("only") || text.includes("few positions") || text.includes("spots left")) {
