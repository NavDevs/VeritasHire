...
export default function RecentAnalysis() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <Section maxWidth="4xl" className="relative min-h-[60vh] flex items-center justify-center pt-16">
          ...
          {history.length === 0 ? (
            <Card className="p-12 text-center">
              <div className="max-w-md mx-auto space-y-4">
                ...
                <h3 className="text-xl font-heading font-semibold">No Analysis History</h3>
                <p className="text-muted-foreground">
